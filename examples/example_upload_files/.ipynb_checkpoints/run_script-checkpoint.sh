...
#SBATCH --account=blanca-ics-vrp
#SBATCH --time=24:00:00
#SBATCH --array=1-110%36
#SBATCH --output=sbatchlogs/vrp_fmriprep_%A_%a.out
#SBATCH --error=sbatchlogs/vrp_fmriprep_%A_%a.err
...
#
studydir=/pl/active/ceko/projects/VRP
#
# !! Freesurfer license location should be updated!! ##
fslicense=/pl/active/ics/containers/fmriprep/license.txt
#
...
# Set up job array index - calls subject number from lsist of inputs
